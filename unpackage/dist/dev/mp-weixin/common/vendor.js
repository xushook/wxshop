...
function initRuntimeSocketService() {
  const hosts = "26.25.211.47,192.168.1.12,127.0.0.1";
  const port = "8090";
  const id = "mp-weixin_EDgWVO";
...
const onNavigationBarSearchInputClicked = /* @__PURE__ */ createLifeCycleHook(
  ON_NAVIGATION_BAR_SEARCH_INPUT_CLICKED,
  2
  /* HookFlags.PAGE */
);
...
class Request {
  ...
  constructor(arg = {}) {
    if (!isPlainObject(arg)) {
      arg = {};
      index.__f__("warn", "at node_modules/luch-request/src/lib/core/Request.js:37", "设置全局参数必须接收一个Object");
    }
